...
/*echo "<pre>";
print_r($_GET['prod']);
echo "El valor de $productoSeleccionado";
print_r($productoSeleccionado);
echo"</pre>";*/

/*$miObjetoDadatina = new Dadatina();
$catalogo =$miObjetoDadatina->piel(intval($productoSeleccionado));*/
$catalogo=(new Piel())->piel_x_id($productoSeleccionado)->getTipo_piel();
$pieles=(new Dadatina())->piel(intval($productoSeleccionado));
...
<div class=" d-flex justify-content-center p-5 bg-rosita">
    <div>
        <h1 class="text-center mb-5 fw-bold">Nuestro Catálogo de <?= $catalogo?></h1>
        ...
        <div class="container">
            ...
            <?PHP foreach ($pieles as $dadatina) { ?>
